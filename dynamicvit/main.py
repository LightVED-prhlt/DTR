...
def get_args_parser():
    ...
    parser.add_argument('--with_dtr', action='store_true', help='Use DTR variant of the model')
...
def main(args):
    ...
    if args.eval:
        ...
        print(f"Accuracy of the network on {len(dataset_val)} test images: {test_stats['acc1']:.3f}%")
        return
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train_stats = train_one_epoch(
            ...
            use_amp=args.use_amp, args=args
        )
        ...
        if data_loader_val is not None:
            ...
            if args.model_ema and args.model_ema_eval:
                ...
                print(f"Accuracy of the model EMA on {len(dataset_val)} test images: {test_stats_ema['acc1']:.3f}%")
                ...
                print(f'Max EMA accuracy: {max_accuracy_ema:.3f}%')
                if log_writer is not None:
