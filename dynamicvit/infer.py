...
def get_args_parser():
    ...
    parser.add_argument('--output_errors', default='misclassified.json', type=str,
                        help='path to save misclassified samples indices')
...
def validate(val_loader, model, criterion):
    ...
    with torch.no_grad():
        ...
        for i, (images, target) in enumerate(val_loader):
            ...
            # compute output
            output = model(images, with_dtr=args.with_dtr)
